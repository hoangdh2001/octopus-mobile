...
class PagedValueListView<K, V> extends StatefulWidget {
  ...
  final PagedValueBloc<K, V> controller;
...
class _PagedValueListViewState<K, V> extends State<PagedValueListView<K, V>> {
  PagedValueBloc<K, V> get _controller => widget.controller;
  ...
  void initState() {
    super.initState();
    _controller.add(const DoInitialLoad());
  }
  ...
  Widget build(BuildContext context) =>
      BlocConsumer<PagedValueBloc<K, V>, PagedValueState<K, V>>(
        bloc: _controller,
                ...
                if (!_hasRequestedNextPage) {
                  ...
                  if (nextPageKey != null && isBuildingTriggerIndexItem) {
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      if (error == null) {
                        _controller.add(LoadMore(nextPageKey));
                      }
                      _hasRequestedNextPage = false;
                    });
